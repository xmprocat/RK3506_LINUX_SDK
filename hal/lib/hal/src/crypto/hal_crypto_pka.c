...
#if (defined(RKMCU_RK2206) || defined(RKMCU_RK2118) || defined(SOC_RK3506)) && defined(HAL_CRYPTO_MODULE_ENABLED)
...
#endif /* (RKMCU_RK2206 || RKMCU_RK2118 || SOC_RK3506) && HAL_CRYPTO_MODULE_ENABLED */
