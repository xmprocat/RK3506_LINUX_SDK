...
typedef enum CLOCK_Name {
    ...
    CCLK_SDMMC0          = CLK64(CCLK_SDMMC0_SEL, CCLK_SDMMC0_DIV),
    CCLK_SDMMC1          = CLK64(CCLK_SDMMC1_SEL, CCLK_SDMMC1_DIV),

    MCLK_PDM             = CLK64(MCLK_PDM_SEL, MCLK_PDM_DIV),

    ACLK_VO              = CLK64(ACLK_VO_PRE_SEL, ACLK_VO_PRE_DIV),
    DCLK_VOP             = CLK64(DCLK_VOP_SEL, DCLK_VOP_DIV),

    CLK_GMAC_125M_CRU_I  = CLK64(CLK_GMAC_125M_CRU_I_SEL, 0U),
    CLK_GMAC_50M_CRU_I   = CLK64(CLK_GMAC_50M_CRU_I_SEL, 0U),
    CLK_GMAC_ETH_OUT2IO  = CLK64(CLK_GMAC_ETH_OUT2IO_SEL, CLK_GMAC_ETH_OUT2IO_DIV),
    CLK_MAC100_50M       = CLK64(CLK_MAC100_50M_MATRIX_SEL, 0U),

    CLK_TSADC            = CLK64(0U, CLK_TSADC_DIV),
    CLK_TSADC_TSEN       = CLK64(0U, CLK_TSADC_TSEN_DIV),

    CLK_CAM0_OUT2IO      = CLK64(CLK_CAM0_OUT2IO_SEL, CLK_CAM0_OUT2IO_DIV),
    CLK_CAM1_OUT2IO      = CLK64(CLK_CAM1_OUT2IO_SEL, CLK_CAM1_OUT2IO_DIV),
    CLK_CAM2_OUT2IO      = CLK64(CLK_CAM2_OUT2IO_SEL, CLK_CAM2_OUT2IO_DIV),
    CLK_CAM3_OUT2IO      = CLK64(CLK_CAM3_OUT2IO_SEL, CLK_CAM3_OUT2IO_DIV),
    ...
    CLK_SAI0_SRC         = CLK64(CLK_SAI0_SRC_SEL, CLK_SAI0_SRC_DIV),
    CLK_SAI0_FRAC        = CLK64(0U, CLK_SAI0_FRAC_DIV),
    CLK_SAI0             = CLK64(MCLK_SAI0_SEL, 0U),
    CLK_SAI1_SRC         = CLK64(CLK_SAI1_SRC_SEL, CLK_SAI1_SRC_DIV),
    CLK_SAI1_FRAC        = CLK64(0U, CLK_SAI1_FRAC_DIV),
    CLK_SAI1             = CLK64(MCLK_SAI1_SEL, 0U),
    CLK_SAI2_SRC         = CLK64(CLK_SAI2_SRC_SEL, CLK_SAI2_SRC_DIV),
    CLK_SAI2_FRAC        = CLK64(0U, CLK_SAI2_FRAC_DIV),
    CLK_SAI2             = CLK64(MCLK_SAI2_SEL, 0U),
    CLK_SPDIF_SRC        = CLK64(CLK_SPDIF_SRC_SEL, CLK_SPDIF_SRC_DIV),
    CLK_SPDIF_FRAC       = CLK64(0U, CLK_SPDIF_FRAC_DIV),
    CLK_SPDIF            = CLK64(MCLK_SPDIF_SEL, 0U),
} eCLOCK_Name;
#endif /* __ASSEMBLY__ */
