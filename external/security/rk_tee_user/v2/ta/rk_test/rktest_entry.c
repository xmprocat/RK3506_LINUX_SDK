				      ...
				      uint32_t param_types, TEE_Param params[4])
{
	...
	case RKTEST_TA_CMD_KEYLAD_TEST:
		return handle_keylad_test();
	case RKTEST_TA_CMD_KEYLAD_WRITE:
		return handle_keylad_write();
	case RKTEST_TA_CMD_KEYLAD_HMAC:
		return handle_keylad_hmac();
	default:
